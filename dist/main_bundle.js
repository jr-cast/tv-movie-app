...
eval("throw new Error(\"Module parse failed: Cannot use keyword 'await' outside an async function (61:24)\\nYou may need an appropriate loader to handle this file type, currently no loaders are configured to process this file. See https://webpack.js.org/concepts#loaders\\n|       commentBtn.addEventListener(\\\"click\\\", () => {\\n|         const baseURL =\\\"https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/\\\";\\n>         const connect = await fetch(`${baseURL}zggEBXzpFcQqjDxvMhMz/comments/`, {\\n|           method: \\\"POST\\\",\\n|           body: JSON.stringify({ item_id: commentBtn.id, username: input_name.value, comment: input_comment.value}),\");\n\n//# sourceURL=webpack://javascript-capstone/./src/modules/detailsDVD.js?");
...
"use strict";
eval("module.exports = __webpack_require__.p + \"7fabfbee8e110b32727e.png\";\n\n//# sourceURL=webpack://javascript-capstone/./src/images/logo.png?");
